...
publicos = {
    "trabalhadores": f"Selic 14.25% corrói seu PLR. Com Selix 9,25%, você receberia até R$ X a mais. Exija #TrampoForte!",
    ...
    "sindicatos": f"Selic 14.25% bloqueia PLR em empresas em RJ. Mobilização pela Selix 9,25% já!",
...
msg += f"🏢 {emp['nome']} ({emp['acao']}): Selic 14.25% > ROI.\n"
...
msg += f"📊 Selic ideal 9,25% (vs 14,25%). Economia anual de R$ 345 bi.\n"
