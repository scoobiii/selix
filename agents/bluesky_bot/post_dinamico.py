...
try:
    ...
    post = f"SELIX: Selic ideal 9,25% (vs 14,25%). Brent US$ {brent} → {etanol}/{biodiesel}. Economia de R$ 345 bi/ano. #Selix #Economia"
except Exception as e:
    post = f"SELIX: Selic ideal 9,25% (vs 14,25%). Economia de R$ 345 bi/ano. #Selix #Economia (dados temporários)"
