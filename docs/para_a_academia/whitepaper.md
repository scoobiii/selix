...
## Resumo
Este artigo apresenta o modelo SELIX, que calcula a Taxa Selic ideal por meio de quatro restrições: Investment Grade (≤9,99%), juro real máximo (5%), não canibalização do ROE (≤ROE×0,95) e convergência com média global. O modelo foi provado formalmente com Z3 (5 teoremas), Lean 4 e testes unitários (pytest). O resultado indica que a Selic deveria ser 9,25% (atualmente 14,25%), gerando economia anual de R$ 345 bilhões e elevando o Brasil ao Investment Grade (BBB+).

## Metodologia
- Dados: IPCA-12 (4,48% – BCB SGS 13522), ROE IBOVESPA (31,23% – Ranking B3), Selic Copom (14,25%).
